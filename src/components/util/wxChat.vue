...
<style scoped>
    .wxchat-container{ width: 100%; height: 100%; position: absolute; left:0; top: 0; overflow: hidden;}
    .shadow{ position: absolute; top:0; left: 0;  width: 100%; height: 100%; background: #000; opacity: .2; }
    .window {box-shadow: 1px 1px 20px -5px #000; /*max-width: 450px;*/ min-width: 300px; background: #F5F5F5; margin: 0 auto; overflow: hidden; padding: 0; height: 100%;position: relative;}
...
<template>
    <div class="wxchat-container" :style="{backgroundColor: options.wrapBg}">
        <div class="window" id="window-view-container" :style="{maxHeight: options.maxHeight + 'px', width: '100%'}">
            <!-- data is empty -->
